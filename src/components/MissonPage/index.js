...
const MissionPage = () => (
    ...
    <div className="mission-page" id="missionvision">
        <div className="misison-page-bg">
            <h1 className="mission-page-main-heading" data-aos="fade-down" data-aos-duration="900">Our <span className="mission-page-span">Mission & Vision</span> for a Sustainable Tomorrow</h1>
        </div>
