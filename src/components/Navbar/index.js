        ...
        <>
            <nav className="navbar" id="navbar">
                ...
                <div className="nav-link-container">
                    ...
                    <div className="link-element">
                        <div className="dropdown">
                            ...
                            <div className="dropdown-menu">
                                <a className="dropdown-anchor" href="/mission-vision" rel='noreferrer'><MdKeyboardArrowRight className="dropdown-arrow" /> Our Mission and Vision</a>
                    ...
                    <Link className="link-element" to="/product">
            ...
            <div className={`mobile-view-navigation ${mobileNav ? "mobile-view-navigation-show" : ""}`}>
                <div className="navlink-mobile-view">
                        ...
                        <div className={`mobile-dropdown-container ${mobileDropDown ? "mobile-dropdown-container-show" : ""}`}>
                            <a className="dropdown-anchor" href="/mission-vision" rel='noreferrer' onClick={customUpdateNav}><MdKeyboardArrowRight className="dropdown-arrow" /> Our Mission and Vision</a>
